...
<head>
    ...
    <title>Lista de Faturamentos</title>
...
<br><br><br>                               
    ...
    <div class = "container">
        ...
        <div class = "box box2">  
            ...
            <a href="todos_fat.php"><button class="btn btn-secondary">Listar Todos</button></a> <br><br><br>
            <h2> Pesquisa de Recebido por Cliente</h2>
            <form action = "pesquisa_fat.php" method="post">
                <label for="idCliente">Código do Cliente:</label>
                <input type="int" name = "idCliente" id = "idCliente"><br><br>
