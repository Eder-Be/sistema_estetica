...
<br><br><br>                               
    ...
    <div class = "container">
        ...
        <div class = "box box2">        
         <h2> Agendamento de Cliente</h2><br><br>
         <form action = "inclui_agendamento.php" method="post">
            ...
            <input type="date" name = "dataAg" id = "dataAg"><br><br>
            <label for="horario">Horário:</label>
            <input type="time" name = "horario" id = "horario"><br><br>
            <label for="codProcedimento">Código do Procedimento:</label>
            <input type="int" name = "codProcedimento" id = "codProcedimento"><br><br>
