...
<br><br><br>                               
    ...
    <div class = "container">
            ...
            <div class="dropdown">
                <button class="btn btn-secondary dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-expanded="false">Agendamentos</button>
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="agenda.php"><button class="dropdown-item" type="button">Pesquisa</button></a></li>
                    </ul>
            </div>
            <br>            
        ...
        <div class = "box box2">        
         <h2>Fatura: Recebido de Cliente</h2><br><br>
         <form action = "inclui_fatura.php" method="post">
            <label for="codCliente">Código do Cliente:</label>
            <input type="int" name = "codCliente" id = "codCliente"><br><br>
            <label for="dataPag">Data:</label>
            <input type="date" name = "dataPag" id = "dataPag"><br><br>
